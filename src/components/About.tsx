      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="text-center mb-12">
            <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-4">What Drives Us</h3>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {values.map((value, index) => {
              ...
              return (
                ...
                >
                  <Card className="h-full border-0 shadow-lg hover:shadow-xl transition-all duration-300 dark:bg-slate-800">
        ...
        >
          <div className="bg-slate-50 dark:bg-slate-800 rounded-3xl p-12">
            <div className="text-center mb-8">
              <h3 className="text-3xl font-bold text-slate-900 dark:text-slate-100 mb-2">By the Numbers</h3>
              <p className="text-slate-600 dark:text-slate-400">Our impact in the creative community</p>
            </div>
        ...
        >
          <div>
            ...
            <div className="flex flex-wrap gap-4">
              <Badge variant="secondary" className="bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300">AI Research</Badge>
              <Badge variant="secondary" className="bg-purple-100 dark:bg-purple-900 text-purple-700 dark:text-purple-300">Creative Writing</Badge>
              <Badge variant="secondary" className="bg-green-100 dark:bg-green-900 text-green-700 dark:text-green-300">Education</Badge>
              <Badge variant="secondary" className="bg-orange-100 dark:bg-orange-900 text-orange-700 dark:text-orange-300">UX Design</Badge>
            </div>
          </div>
          <div className="relative">
            <div className="bg-gradient-to-br from-purple-100 to-pink-100 dark:from-purple-900 dark:to-pink-900 rounded-3xl p-8 text-center">
        ...
        <motion.div
          ...
          className="text-center"
        >
          <div className="bg-gradient-to-r from-slate-900 to-slate-800 dark:from-slate-800 dark:to-slate-700 rounded-3xl p-12 text-white">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="border-2 border-slate-500 dark:border-slate-600 text-slate-300 dark:text-slate-400 hover:bg-slate-800 dark:hover:bg-slate-600 px-8 py-4 text-lg">
                Learn More About Us
              </Button>
            </div>
          </div>
